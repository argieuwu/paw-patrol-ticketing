...
class Apiservice {
    final String secretKey = 'sk_test_899mPkGNAeddzutaZibPTV4U'; // Yes aware ko haha
  ...
  Future<UserCheckout> getCheckout(String id) async {
    final response = await http.get(Uri.parse('https://api.paymongo.com/v1/checkout_sessions/$id'),
        headers: {
          HttpHeaders.authorizationHeader: basicAuth,
